...
class PatchEmbed2D(nn.Module):
    ...
    def __init__(self, patch_size=4, in_chans=3, embed_dim=96, norm_layer=None, **kwargs):
        ...
        print("356Patch_size:", patch_size)
...
class SS_Conv_SSM(nn.Module):
    ...
    def forward(self, input: torch.Tensor):
        ...
        # print(f"Layer output size:{x.shape}")
        ...
        output = self.channel_shuffle(output, groups=2)
        output = self.output_layer(output, input)
        return output
...
# decmamba_t = VSSM(depths=[2, 2, 4, 2],dims=[96,192,384,768],num_classes=8).to("cuda")
# decmamba_s = VSSM(depths=[2, 2, 8, 2],dims=[96,192,384,768],num_classes=8).to("cuda")
# decmamba_b = VSSM(depths=[2, 2, 12, 2],dims=[128,256,512,1024],num_classes=8).to("cuda")
#
# data = torch.randn(1,3,224,224).to("cuda")
#
# print(decmamba_t(data).shape)
